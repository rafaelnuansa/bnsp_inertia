...
export default function SalesCreate() {
    const { errors, products } = usePage().props; // Ambil produk dari usePage()
    ...
    return (
        <>
            <Head>
                <title>Create Sales - Inventory Management</title>
            </Head>
            ...
            <AppLayout>
                <Container>
                    <Card>
                        <CardHeader>
                            <h3 className="text-lg font-semibold">Tambah Penjualan Baru</h3>
                        </CardHeader>
                        <CardContent>
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-4">
                                    ...
                                    />
                                    {errors.quantity && <div className="text-red-500">{erroars.quantity}</div>}
                                </div>
